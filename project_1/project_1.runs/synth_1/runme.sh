...
HD_PWD='C:/Users/solomspd.AUC/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_cycle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basic_cycle.tcl
