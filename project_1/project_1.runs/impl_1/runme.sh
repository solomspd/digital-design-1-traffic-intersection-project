...
HD_PWD='C:/Users/solomspd.AUC/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_cycle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basic_cycle.tcl -notrace
